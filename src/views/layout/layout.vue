 <template>
    <el-container style="height: 100%;">
      <!-- 头部 -->
      <el-header style="text-align: right; font-size: 12px;background-color: whitesmoke;">
        <el-dropdown>
       ...
       <el-aside width="200px">
         <el-menu>
           ...
           <template v-for="item in menuData" v-if="item.meta.menu">
             ...
             <el-submenu :index="item.meta.funcNode">
               ...
               <template v-for="itemC in item.children" v-if="item.children">
                 <el-menu-item :index="itemC.meta.funcNode" @click="clickMenu(itemC)"><i :class="itemC.meta.icon"></i>{{itemC.meta.title}}</el-menu-item>
               </template>
             </el-submenu>
           </template>
         </el-menu>
